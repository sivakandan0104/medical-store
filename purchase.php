...
$sql = "SELECT * FROM medicine WHERE name = '$searchItem'";
...
if (isset($_POST["order"])) {
    ...
    $insertQuery = "INSERT INTO orders (customer_name, item_name, amount, category, status, order_date, address, quantity) 
                                    VALUES ('$username', '$searchItem', $cal_amount, '$category', '$status', '$orderDate', '$address', $quantity)";
...
<body>
    ...
    <div class="main">
        ...
        <div class="content">
            <div class="center">
                <div class="display">
                    <p>ITEM NAME:<span id="value"><?php echo ucfirst($searchItem) ?></span></p>
                </div>
                <div class="display">
                    <p>AMOUNT: <span id="value">RS.<?php echo "$amount" ?></span></p>
                </div>
                <div class="display">
                ...
                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
                    ...
                    <input type="number" name="quan" min="1" max="5"><br><br><br>
                    <label>ADDRESS :</label><br><br><br>
                    <textarea name="addr" rows="5" required></textarea>
